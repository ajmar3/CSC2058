...
public class ChanceTileImpl implements ChanceTileInterface {
	...
	public void drawCard(Player player, Tile tile) {
		...
		/*
		String[] chancesCode = new String[4];
		...
		String[] chances = {"Back to Go!","Go to Jail!","Back Two Spaces","You won $100","Pay $50 for NGOs on animal services."};
		...
		if (i == 0) {
			...
			System.out.println("You are now in " + player.getCurrentTile().name);
		} else if (i == 1) {
