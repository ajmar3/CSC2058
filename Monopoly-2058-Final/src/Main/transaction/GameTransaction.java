...
public class GameTransaction {
	...
	public void turn() {
		...
		for (int i = 0; i < gamePlayers.size(); i++) {
			...
			System.out.println(gamePlayers.get(i).getBalance());		
        ...
        {	
            ...
            {	
                ...
                {	
                	...
                	System.out.println(gamePlayers.get(ans).getName() + " " + "do you wish to accept this trade? (Yes/no)");
		...
		{    		  		
			...
			if (playerChoice.equalsIgnoreCase("Yes")) 
			{
	            ...
	            if(numeric) 
	            {
					...
					System.out.println(player.getName() + " now has a balance of Â£" + player.getBalance());
					holder = true;
	            }
	...
	public void getOutJail(Player player, int dice1, int dice2) 
	{
		...
		while(holder == false)
		{
			try
			{
			System.out.println(player.getName()	+ ", you are currently in jail! To get out you can \n  1. pay the Â£200 jail fee. \n 2. attempt to roll a double. \n Enter your choice: ");
        ...
        if(numeric) 
        {
    		...
    		case 1:
    			if (player.getBalance() >= 200)
    			{
    				...
    				player.setCurrentTile(LoadTileTransaction.gameTiles.get(10));
    				System.out.println(player.getName()+ ", you are now free from jail and are on the visiting jail tile. You may continue on your next turn");
    				holder = true;
    			} 
    			else 
    			{
